...
export default function UserProfile() {
  ...
  <div
    class="bg-gray-800  relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform">
    ...
    <div class="px-4 py-5 sm:px-6">
        ...
        <p class="mt-1 max-w-2xl text-sm text-gray-500">
            Details and informations your data.
        </p>
    </div>
    <div class="border-t ">
        <dl>
            <div class="bg-gray-8000 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
